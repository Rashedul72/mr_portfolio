              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="bg-white/[0.03] backdrop-blur-sm p-6 rounded-xl border border-white/[0.06] hover:bg-white/[0.06] transition-all duration-300">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="ml-4 font-semibold text-white">Product Catalog</h3>
                  </div>
                  <p className="text-slate-400">Extensive catalog with category filtering</p>
                </div>
                <div className="bg-white/[0.03] backdrop-blur-sm p-6 rounded-xl border border-white/[0.06] hover:bg-white/[0.06] transition-all duration-300">
                  <div className="flex items-center mb-4">
                    <div className="bg-emerald-500/10 p-3 rounded-xl">
                    ...
                    <h3 className="ml-4 font-semibold text-white">Order Management</h3>
                  </div>
                  <p className="text-slate-400">Complete order tracking system</p>
                </div>
                <div className="bg-white/[0.03] backdrop-blur-sm p-6 rounded-xl border border-white/[0.06] hover:bg-white/[0.06] transition-all duration-300">
                  <div className="flex items-center mb-4">
                    <div className="bg-emerald-500/10 p-3 rounded-xl">
                    ...
                    <h3 className="ml-4 font-semibold text-white">Vendor Dashboard</h3>
                  </div>
                  <p className="text-slate-400">Dedicated interface for sellers</p>
                </div>
                <div className="bg-white/[0.03] backdrop-blur-sm p-6 rounded-xl border border-white/[0.06] hover:bg-white/[0.06] transition-all duration-300">
                  <div className="flex items-center mb-4">
                    <div className="bg-emerald-500/10 p-3 rounded-xl">
              ...
              <div className="bg-white/[0.03] backdrop-blur-sm rounded-xl p-8 border border-white/[0.06] w-full">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-slate-300">Multi-vendor marketplace with individual storefronts</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-flex items-center justify-center h-6 w-6 rounded-full bg-cyan-500/20 text-cyan-400 font-bold text-sm mr-3 mt-0.5">✓</span>
                    <span className="text-slate-300">Advanced inventory management and order processing</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-flex items-center justify-center h-6 w-6 rounded-full bg-cyan-500/20 text-cyan-400 font-bold text-sm mr-3 mt-0.5">✓</span>
                    <span className="text-slate-300">Secure payment integration and order tracking</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-flex items-center justify-center h-6 w-6 rounded-full bg-cyan-500/20 text-cyan-400 font-bold text-sm mr-3 mt-0.5">✓</span>
                    <span className="text-slate-300">Comprehensive analytics and reporting system</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mt-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white/[0.03] backdrop-blur-sm p-8 rounded-2xl border border-white/[0.06] hover:bg-white/[0.06] transition-all duration-300">
              ...
              <ShoppingCart className="text-emerald-400 w-8 h-8 mb-6" />
            ...
            <div className="bg-white/[0.03] backdrop-blur-sm p-8 rounded-2xl border border-white/[0.06] hover:bg-white/[0.06] transition-all duration-300">
              <div className="h-1 bg-gradient-to-r from-cyan-400 to-violet-500 rounded-t-2xl -mt-8 -mx-8 mb-6" />
              <Monitor className="text-emerald-400 w-8 h-8 mb-6" />
              <h3 className="text-xl font-semibold text-white mb-4">Vendor Dashboard</h3>
              <p className="text-slate-400">
            ...
            <div className="bg-white/[0.03] backdrop-blur-sm p-8 rounded-2xl border border-white/[0.06] hover:bg-white/[0.06] transition-all duration-300">
              <div className="h-1 bg-gradient-to-r from-cyan-400 to-violet-500 rounded-t-2xl -mt-8 -mx-8 mb-6" />
              <TrendingUp className="text-emerald-400 w-8 h-8 mb-6" />
              <h3 className="text-xl font-semibold text-white mb-4">Analytics & Reports</h3>
              <p className="text-slate-400">
          ...
          <div className="mb-20">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1">
                <h3 className="text-2xl font-bold text-white mb-4">Powerful Dashboard</h3>
          ...
          <div className="bg-white/[0.03] backdrop-blur-sm rounded-2xl p-8 border border-white/[0.06]">
            <div className="grid grid-cols-2 md:grid-cols-7 gap-6">
              <div className="flex flex-col items-center p-4 hover:bg-white/[0.06] rounded-xl transition-colors duration-300">
                <Globe className="text-emerald-400 w-12 h-12 mb-3" />
