          ...
          <div className="rounded-3xl bg-gradient-to-r from-cyan-500/40 via-violet-500/40 to-rose-500/40 p-px">
            <div className="rounded-3xl bg-[#0a0a1a] p-6 sm:p-10 lg:p-16">
              ...
              <div className="text-center mb-10 lg:mb-14">
                ...
                />
                <motion.p
                  className="text-base sm:text-lg text-slate-400 mt-6 max-w-xl mx-auto"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <h3 className="text-sm font-semibold text-slate-300 mb-0.5">{info.title}</h3>
                      <p className="text-sm text-slate-500 group-hover:text-cyan-400 transition-colors truncate">{info.value}</p>
                    </div>
                  </motion.a>
                ))}
              </div>
              ...
              >
                ...
                <motion.a
                  ...
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-cyan-500 to-violet-500 text-white px-8 py-3.5 rounded-xl font-semibold transition-all duration-300 shadow-[0_0_25px_rgba(34,211,238,0.2)] hover:shadow-[0_0_40px_rgba(34,211,238,0.4)]"
